@echo off
echo Plug ^Plug Plug Play & Play Framework Installer for Windows
echo ===============================================
...
echo [BUILD] Building Plug & Play Framework...
...
echo [BUILD] Downloading GLM-4-9B model...
if not exist ..\glm-4-9b.gguf (
    ...
    echo [OK] GLM-4-9B model already exists
)
